...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Toko</h1>
                <p class="text-gray-600 text-sm sm:text-base">Kelola data toko</p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center justify-end gap-1 sm:gap-2">
                                        ...
                                        <form method="POST" action="{{ route('stores.destroy', $s) }}" class="inline"
